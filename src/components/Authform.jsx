      ...
      <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          ...
          <div className="mt-12 flex flex-col items-center">
            ...
            <div className="w-full flex-1 mt-8">
              <form onSubmit={handleSubmit} className="mx-auto max-w-xs">
                  ...
                  <>
                    ...
                    <p
                      className={`text-xs md:text-sm text-red-500 ${
                        usernameErrMessage !== "Empty" ? "visible" : "invisible"
                      }`}
                    >
                      {usernameErrMessage}
                    </p>
                    ...
                    <p
                      className={`text-xs md:text-sm text-red-500 ${
                        emailErrMessage !== "Empty" ? "visible" : "invisible"
                      }`}
                    >
                      {emailErrMessage}
                    </p>
                ...
                <p
                  className={`text-xs md:text-sm text-red-500 ${
                    passwordErrMessage !== "Empty" ? "visible" : "invisible"
                  }`}
                >
                  {passwordErrMessage}
                </p>
                ...
                >
                  ...
                  <span
                    className={` ml-3 ${loading ? "invisible" : "visible"}`}
                  >
                    {isLogin ? "Login" : "Sign Up"}
                  </span>
                </button>
                <div className="flex justify-center">
                  <button  onClick={handleForgetPassword} className="text-orange-400 hover:text-orange-600   py-2">
                    Forget Password
                  </button>
                </div>
              </form>
        ...
        <div className="flex-1 bg-orange-100 text-center hidden lg:flex items-center justify-center">
          <div
            ...
            style={{
              backgroundImage: `url(${
                import.meta.env.VITE_API_LOG_SIGN_IMAGE
              })`,
            }}
          ></div>
        </div>
